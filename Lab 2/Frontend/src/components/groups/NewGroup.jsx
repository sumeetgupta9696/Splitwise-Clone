...
class NewGroup extends Component {
  ...
  render() {
    ...
    if (this.state.message === 'DUPLICATE_GROUP') {
      alert("Group Name already exist! Please enter unique groupname");
    }
    selfMember = (
      <Form.Row>
    ...
    const groupImage = 'https://testbucket9696.s3.us-east-2.amazonaws.com/groupImages/default-pic.png';
    const filename = this.state.filename || 'Select image file';
      ...
      <div>
        ...
        <div className="mt-5">
          <Row>
              ...
              <Form noValidate validated={this.state.imageFormValidated} onSubmit={this.onUpload}>
                <Form.Row className="mt-4">
                  <Form.Group as={Col} md={3}>
                    <Image style={{ width: '12rem' }} src={groupImage} />
                  </Form.Group>
                </Form.Row>
                <Form.Row>
                  <Form.Group as={Col} md={3}>
            ...
            <Col md={{ span: 6 }}>
              <h5 className="text-muted">ENTER GROUPNAME</h5>
              ...
              <Form onSubmit={this.onSave}>
                ...
                <Form.Row>
                  <Form.Group>
                    <Button onClick={this.onAddInvitationForm} variant="outline-secondary">+</Button>
                  </Form.Group>
                </Form.Row>
                <Form.Row>
                  {/* <Link to="/home"> */}
                  <Button style={{"background-color":"#5BC5A7"}}  variant="light" type="submit" onSubmit="http://3.140.249.44:3000/home">Create Group</Button>
                  {/* </Link> */}
                </Form.Row>
              </Form>
            </Col>
